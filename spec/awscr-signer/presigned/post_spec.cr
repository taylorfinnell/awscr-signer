      ...
      describe Post do
        describe "valid?" do
          it "returns true if bucket and policy are valid" do
            ...
            post.build { |b| b.eq("bucket", "t"); b.expiration(Time.now) }
        ...
        describe "fields" do
          it "contains the policy field" do
            ...
            post.build { |b| b.eq("bucket", "t"); b.expiration(time) }

            field = post.fields.select { |f| f.key == "policy" }
            (field.size > 0).should be_true
            field.first.value.join.should eq("")
          end
          ...
          it "contains the signature field" do
            ...
            (field.size > 0).should be_true
            field.first.value.join.should eq("c979e44c58c8df84951d121f7c66b62f2fbb3a2729dded7fd2708bdd763ff72e")
          end
          ...
          it "contains the credential field" do
            ...
            (field.size > 0).should be_true
            field.first.value.join.should eq("test/19700101/us-east-1/s3/aws4_request")
          end
          ...
          it "contains the algorithm field" do
            ...
            (field.size > 0).should be_true
            field.first.value.join.should eq(Signer::ALGORITHM)
          end
          ...
          it "contains the date field" do
            ...
            (field.size > 0).should be_true
            field.first.value.join.should eq("19700101T000001Z")
          end
        ...
        describe "url" do
          ...
          it "includes the bucket field" do
            creds = Credentials.new("test", "test")
            post = Post.new("us-east-1", creds)
            post.build { |b| b.expiration(Time.now); b.eq("bucket", "test") }
